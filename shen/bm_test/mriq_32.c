...
struct timeval tstart,tend,tv1,tv2,tv3,tv4,tv5,tv6,tv7;
ssize_t t1,t2,t3,t4,t5,t6,t7,temp1,temp2,temp3,temp4,temp5,temp6;
...
int main(int argc, char *argv[]) {
	...
	if (fdw32_1 < 0 || fdw32_2 < 0 || fdw32_3 < 0 || fdw32_4 < 0 || fdw32_5 < 0 || fdw32_6 < 0 || fdr32_1 < 0) {
...
//gettimeofday(&tv6, NULL);
	...
	t7= read(fdr32_1, array_hardware_A, sizeof(int)*N);
