...
struct timeval tstart,tend,tv1,tv2,tv3,tv4,tv5,tv6,tv7,tv8,tv9,tv10,tv11,tv12;
...
gettimeofday(&tv10, NULL);
	...
	t11= read(fdr16_1, array_hardware_A, sizeof(int)*N);
gettimeofday(&tv11, NULL);
	t12= read(fdr16_2, array_hardware_B, sizeof(int)*N);
